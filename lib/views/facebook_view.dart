...
class _FaceBookViewState extends State<FaceBookView> with SingleTickerProviderStateMixin {
  late TabController _tabController = new TabController(length: widget.items.length, vsync: this);
  late QonvexUISettings settings = widget.settings;
  late Color mainColor = QonvexColorChecker.check(settings.foregroundColor);
  late Color secondaryColor = QonvexColorChecker.checkNegative(settings.foregroundColor);
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: kIsWeb && _isWeb ? null : AppBar(
        ...
        bottom: PreferredSize(
          ...
          child: Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: size.width > 800 && size.width < 1300 ? size.width * .2 : 0),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 60,
                      child: settings.appHeaderActions != null ? Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                        children: [
                          for(Widget action in settings.appHeaderActions!)...{
                            Theme(
                              data: ThemeData(
                                iconTheme: IconThemeData(
                                  color: mainColor
